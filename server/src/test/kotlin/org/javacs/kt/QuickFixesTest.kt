...
class ImplementAbstractMembersQuickFixTest : SingleFileTestFixture("quickfixes", "SomeSubclass.kt") {
    ...
    fun `gets workspace edit for super class abstract methods when interface methods are implemented`() {
        ...
        val codeActionParams =
            codeActionParams(file, 10, 1, 10, 25, listOf(diagnostic), listOf(CodeActionKind.QuickFix))
...
class ImplementAbstractMembersQuickFixSameFileTest : SingleFileTestFixture("quickfixes", "samefile.kt") {
    ...
    fun `should find one abstract method to implement`() {
        ...
        assertThat(
            functionToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun test(input: String, otherInput: Int) { }")
        )
    }
    ...
    fun `should find several abstract methods to implement`() {
        ...
        assertThat(
            firstFunctionToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun print() { }")
        )
        ...
        assertThat(
            secondFunctionToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun test(input: String, otherInput: Int) { }")
        )
    }
    ...
    fun `should respect nullability of parameter and return value in abstract method`() {
        ...
        assertThat(
            functionToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun myMethod(myStr: String?): String? { }")
        )
    }
    ...
    fun `should find abstract variable and function`() {
        ...
        assertThat(
            firstMemberToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override val name: String = TODO(\"SET VALUE\")")
        )

        val secondMemberToImplementEdit = textEdit[key]?.get(1)
        assertThat(secondMemberToImplementEdit?.range, equalTo(range(35, 35, 35, 35)))
        assertThat(
            secondMemberToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun myFun() { }")
        )
    }
    ...
    fun `should find abstract members when class has no body (square brackets)`() {
        ...
        assertThat(
            secondMemberToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun behaviour() { }")
        )
...
class ImplementAbstractMembersQuickFixExternalLibraryTest : SingleFileTestFixture("quickfixes", "standardlib.kt") {
    ...
    fun `should find one abstract method from Runnable to implement`() {
        ...
        assertThat(
            functionToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun run() { }")
        )
    }
    ...
    fun `should find one abstract method from Comparable to implement`() {
        ...
        assertThat(
            functionToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun compare(p0: String, p1: String): Int { }")
        )
    }
    ...
    fun `should find abstract members for AbstractList`() {
        ...
        assertThat(
            firstMemberToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override val size: Int = TODO(\"SET VALUE\")")
        )
        ...
        assertThat(
            secondMemberToImplementEdit?.newText,
            equalTo(System.lineSeparator() + System.lineSeparator() + "    override fun get(index: Int): String { }")
        )
    }
}
