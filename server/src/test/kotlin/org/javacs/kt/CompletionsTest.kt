...
class InfixMethodTest : SingleFileTestFixture("completions", "InfixFunctions.kt") {
    ...
    @Test
    fun `includes completion for stdlib`() {
    ...
    @Test
    fun `complete extension function`() {
    ...
    @Test
    fun `has global completions for binary expression`() {
