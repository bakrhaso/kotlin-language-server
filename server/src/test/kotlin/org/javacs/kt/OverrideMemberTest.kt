...
class OverrideMemberTest : SingleFileTestFixture("overridemember", "OverrideMembers.kt") {
    ...
    fun `should show all overrides for class`() {
        ...
        assertThat(
            titles, containsInAnyOrder(
                "override val text: String = TODO(\"SET VALUE\")",
                "override fun print() { }",
        ...
        assertThat(
            newTexts, containsInAnyOrder(
                padding + "override val text: String = TODO(\"SET VALUE\")",
    ...
    fun `should find method in open class`() {
        ...
        assertThat(
            titles, containsInAnyOrder(
                "override fun numOpenDoorsWithName(input: String): Int { }",
                "override fun equals(other: Any?): Boolean { }",
                "override fun hashCode(): Int { }",
                "override fun toString(): String { }"
            )
        ...
        assertThat(
            newTexts, containsInAnyOrder(
                padding + "override fun numOpenDoorsWithName(input: String): Int { }",
                padding + "override fun equals(other: Any?): Boolean { }",
                padding + "override fun hashCode(): Int { }",
                padding + "override fun toString(): String { }"
            )
